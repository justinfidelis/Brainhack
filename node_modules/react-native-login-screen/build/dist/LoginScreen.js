...
const dummyFunction = () => { };
const LoginScreen = ({ style, dividerStyle, logoImageStyle, loginTextStyle, loginButtonStyle, signupTextStyle, signupStyle, textInputContainerStyle, signupText = "Create an account", disableDivider, logoImageSource, onLoginPress, disableSocialButtons, onSignupPress, onEmailChange, onPasswordChange, onFacebookPress = dummyFunction, onTwitterPress = dummyFunction, onApplePress = dummyFunction, onDiscordPress = dummyFunction, emailPlaceholder = "Email", passwordPlaceholer = "Password", disableSignup = false, children, }) => {
    ...
    const TextInputContainer = () => (<react_native_1.View style={[LoginScreen_style_1.default.textInputContainer, textInputContainerStyle]}>
      <react_native_text_input_interactive_1.default placeholder={emailPlaceholder} onChangeText={onEmailChange}/>
      <react_native_1.View style={LoginScreen_style_1.default.passwordTextInputContainer}>
        <react_native_text_input_interactive_1.default placeholder={passwordPlaceholer} secureTextEntry onChangeText={onPasswordChange}/>
      </react_native_1.View>
    </react_native_1.View>);
    ...
    const SignUp = () => (<react_native_1.TouchableOpacity style={[LoginScreen_style_1.default.signupStyle, signupStyle]} onPress={onSignupPress}>
      <react_native_1.Text style={[LoginScreen_style_1.default.signupTextStyle, signupTextStyle]}>
        {signupText}
      </react_native_1.Text>
    </react_native_1.TouchableOpacity>);
